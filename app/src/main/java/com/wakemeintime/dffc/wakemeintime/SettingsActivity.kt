...
class SettingsActivity : AppCompatPreferenceActivity() {
    ...
    class MorningRoutinePreferenceFragment : PreferenceFragment() {
        override fun onCreate(savedInstanceState: Bundle?) {
            super.onCreate(savedInstanceState)
            addPreferencesFromResource(R.xml.pref_morningroutine)
            ...
            bindPreferenceSummaryToValue(findPreference("times_5Min_to_1Day_list"))
        }
    ...
    class AlarmPreferenceFragment : PreferenceFragment() {
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            bindPreferenceSummaryToValue(findPreference("alarm_repeat_time"))
            bindPreferenceSummaryToValue(findPreference("alarm_repeat_amount"))
        }
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    class TransportationPreferenceFragment : PreferenceFragment() {
        override fun onCreate(savedInstanceState: Bundle?) {
            super.onCreate(savedInstanceState)
            addPreferencesFromResource(R.xml.pref_transportation)
            setHasOptionsMenu(true)
